---
title: "Measurement Systems: Science, Theory, Engineering"
author: "Brad Venner"
date: "05/23/2023"
...
A 16 week semester with 3 lectures per week gives 48 total lectures. At some point, each lecture should introduce a key concept or problem in measurement. An introductory course, paticularly one focused on developing a trans-disciplinary approach to measurement, can only scratch the surface of the subject. On the other hand, the course should emphasize the basics so that students leave with the confidence to design/improve measurement systems. I think this means that practical subject such as measurement systems analysis and validation should be included. Obviously the VIM provides a list of concepts.
